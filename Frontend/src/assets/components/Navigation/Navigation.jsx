    ...
    <nav className='flex items-center py-6 px-16 justify-between gap-40'>
      ...
      <div className='flex flex-wrap items-center gap-10 flex-1'>
        ...
        <ul className='flex gap-14 '>
          ...
          <li>
            <a href='/mens' className='text-gray-600 hover:text-black'>
              Men
            </a>
          </li>
          <li>
            <a href='/womens' className='text-gray-600 hover:text-black'>
              Women
            </a>
          </li>
          <li>
            <a href='/kids' className='text-gray-600 hover:text-black'>
              Kids
            </a>
          </li>
        </ul>
